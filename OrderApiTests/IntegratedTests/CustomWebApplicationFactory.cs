    ...
    public class CustomWebApplicationFactory : WebApplicationFactory<Program>
    {
        protected override void ConfigureWebHost(IWebHostBuilder builder)
        {
            builder.ConfigureServices(services =>
            {
                ...
                services.AddDbContextPool<AppOrderContext>(options =>
                {
                ...
                {
                    var context = scope.ServiceProvider.GetRequiredService<AppOrderContext>();
        ...
        private static void RemoveLibraryDbContextRegistration(IServiceCollection services)
        {
            var descriptor = services.SingleOrDefault(
                d => d.ServiceType ==
                     typeof(DbContextOptions<AppOrderContext>));
