...
namespace OrderApi.Migrations.SignalR
{
    ...
    [Migration("20240227181356_PopulatedTestTimeEntity")]
    partial class PopulatedTestTimeEntity
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("OrderApi.SignalR.Services.Data.TestTimeEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            FullTime = new DateTime(2024, 2, 27, 20, 13, 56, 405, DateTimeKind.Local).AddTicks(7325),
                            Span = new TimeSpan(0, 2, 0, 0, 0),
                            Time = new TimeSpan(0, 10, 30, 0, 0),
                            TimeOffSet = new DateTimeOffset(new DateTime(2024, 2, 27, 20, 13, 56, 405, DateTimeKind.Unspecified).AddTicks(7392), new TimeSpan(0, 2, 0, 0, 0))
                        });
                });
